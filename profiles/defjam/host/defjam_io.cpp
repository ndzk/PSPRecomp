...
void install_io_hle(Runtime &runtime, const std::string &umd_image) {
    ...
    runtime.register_hle("IoFileMgrForUser", 0xACE946E8u, [](Runtime &rt, AllegrexContext &ctx) {
        ...
        if (ctx.gpr[5] != 0u) write_stat(rt, ctx.gpr[5], host_path, is_dir);
        set_return(ctx, 0u);
    });
    ...
    runtime.register_hle("IoFileMgrForUser", 0xE3EB004Cu, [](Runtime &rt, AllegrexContext &ctx) {
        ...
        if (dirent != 0u) {
            ...
            write_stat(rt, dirent, entry.path(), is_dir);
    ...
    runtime.register_hle("IoFileMgrForUser", 0xE95A012Bu, [](Runtime &, AllegrexContext &ctx) {
        park_async(static_cast<std::int32_t>(ctx.gpr[4]), -1);
        set_return(ctx, 0u);
    });
}
